...
const DEMO_RATES: ExchangeRate[] = [
  ...
  { code: "COP", name: "Peso Colombiano", rate: 4150.0, symbol: "COP" },
  { code: "VES", name: "Bolívar Venezolano", rate: 40.0, symbol: "Bs." },
];
        ...
        {DEMO_RATES.map((rate) => (
          <Card
            ...
            style={{
              ...
              borderTop: `3px solid ${rate.code === "USD" ? "#22C55E" : rate.code === "COP" ? "#3B82F6" : "#F59E0B"}`,
            }}
          >
